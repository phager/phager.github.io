class CarryTradeMatrix {
    constructor() {
        ...
        this.currencies = [
            ...
            },
            {
                ...
                name: "Euro",
                interest: 2.5,
                spot: 1.085, // USD per EUR
                forward: 1.092, // USD per EUR (forward)
            },
            {
                code: "JPY",
                name: "Japanese Yen",
            ...
            },
            {
                ...
                name: "British Pound",
                interest: 5.0,
                spot: 1.265, // USD per GBP
                forward: 1.258, // USD per GBP (forward)
            },
            {
                code: "CHF",
                name: "Swiss Franc",
                interest: 0.25,
                spot: 1.12, // USD per CHF
                forward: 1.135, // USD per CHF (forward)
            },
            {
                code: "CAD",
                name: "Canadian Dollar",
                interest: 4.25,
                spot: 0.73, // USD per CAD
                forward: 0.725, // USD per CAD (forward)
            },
            {
                code: "AUD",
                name: "Australian Dollar",
                interest: 4.35,
                spot: 0.668, // USD per AUD
                forward: 0.665, // USD per AUD (forward)
            },
            {
                code: "NOK",
                name: "Norwegian Krone",
                interest: 4.5,
                spot: 0.093, // USD per NOK
    ...
    renderTabExplanation(root) {
        ...
        if (this.activeTab === "Unhedged") {
            ...
            text =
                "Forward %: Shows the implied forward premium/discount based on current spot and forward rates. This is a data validation tool." +
                forwardNote;
        } else if (this.activeTab === "Hedged") {
            text =
                "Hedged %: Shows the annualized return of a USD-based carry trade, simulating a US investor funding in one currency, investing in another, and hedging FX risk using forwards. Expressed as a % of initial USD invested." +
                forwardNote;
        } else if (this.activeTab === "Example") {
            text =
                "Worked Example: Step-by-step calculation of a USD-based FX-hedged carry trade." +
                forwardNote;
        } else if (this.activeTab === "Summary") {
            text =
                "Summary: Lists each currency and its interest, spot, and forward rates." +
                forwardNote;
        } else if (this.activeTab === "Extremes") {
            text =
